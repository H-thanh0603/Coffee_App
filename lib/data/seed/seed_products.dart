...
List<Product> seedProducts() => [
      ...
      Product(
        ...
        categoryId: 'cat-cafe',
        basePrice: 25000,
        priceBySize: const {DrinkSize.s: 25000, DrinkSize.m: 30000, DrinkSize.l: 35000},
      ...
      Product(
        ...
        categoryId: 'cat-cafe',
        basePrice: 30000,
        priceBySize: const {DrinkSize.s: 30000, DrinkSize.m: 35000, DrinkSize.l: 40000},
        availableToppingIds: const ['tp-coffee-jelly', 'tp-pudding'],
      ),
      Product(
        id: 'p-bac-xiu',
        ...
        categoryId: 'cat-cafe',
        basePrice: 32000,
        priceBySize: const {DrinkSize.s: 32000, DrinkSize.m: 38000, DrinkSize.l: 42000},
      ),
      Product(
        id: 'p-cappuccino',
        name: 'Cappuccino',
        ...
        categoryId: 'cat-cafe',
        basePrice: 45000,
        priceBySize: const {DrinkSize.s: 45000, DrinkSize.m: 50000, DrinkSize.l: 55000},
      ),
      Product(
        id: 'p-latte',
        name: 'Latte',
        ...
        categoryId: 'cat-cafe',
        basePrice: 48000,
        priceBySize: const {DrinkSize.s: 48000, DrinkSize.m: 52000, DrinkSize.l: 58000},
      ),
      // === TRÀ TRÁI CÂY ===
      Product(
        id: 'p-tra-dao',
        ...
        basePrice: 35000,
        priceBySize: const {DrinkSize.s: 35000, DrinkSize.m: 40000, DrinkSize.l: 45000},
      ...
      Product(
        ...
        basePrice: 35000,
        priceBySize: const {DrinkSize.s: 35000, DrinkSize.m: 40000, DrinkSize.l: 45000},
        availableToppingIds: const ['tp-pearl-black', 'tp-pearl-white', 'tp-pudding', 'tp-cheese'],
      ),
      Product(
        id: 'p-trasua-matcha',
        name: 'Trà sữa matcha',
        ...
        categoryId: 'cat-tea-milk',
        basePrice: 42000,
        priceBySize: const {DrinkSize.s: 42000, DrinkSize.m: 48000, DrinkSize.l: 52000},
        availableToppingIds: const ['tp-pearl-black', 'tp-pudding', 'tp-cheese'],
      ),
      Product(
        ...
        categoryId: 'cat-tea-milk',
        basePrice: 40000,
        priceBySize: const {DrinkSize.s: 40000, DrinkSize.m: 45000, DrinkSize.l: 50000},
        availableToppingIds: const ['tp-pearl-black', 'tp-pudding', 'tp-cheese'],
      ),
      // === ĐÁ XAY ===
      Product(
        ...
        basePrice: 50000,
        priceBySize: const {DrinkSize.s: 50000, DrinkSize.m: 55000, DrinkSize.l: 60000},
      ...
      Product(
        ...
        categoryId: 'cat-ice-blend',
        basePrice: 52000,
        priceBySize: const {DrinkSize.s: 52000, DrinkSize.m: 57000, DrinkSize.l: 62000},
        availableToppingIds: const ['tp-cheese'],
      ),
      // === SODA ===
      Product(
        ...
        categoryId: 'cat-soda',
        basePrice: 38000,
        priceBySize: const {DrinkSize.s: 38000, DrinkSize.m: 43000, DrinkSize.l: 48000},
      ),
      // === BÁNH ===
      Product(
        id: 'p-banh-tiramisu',
